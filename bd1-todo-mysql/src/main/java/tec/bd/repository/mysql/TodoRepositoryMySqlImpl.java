...
public class TodoRepositoryMySqlImpl extends BaseRepository<TodoRecord> implements TodoRepository {
    ...
    public TodoRecord save(TodoRecord todoRecord) {
        try {
            ...
            statement.setString(5, String.valueOf(todoRecord.getStartDate()));
            statement.setString(6, String.valueOf(todoRecord.getEndDate()));
    ...
    public TodoRecord update(TodoRecord todoRecord) {
        try {
            ...
            statement.setString(4, String.valueOf(todoRecord.getStartDate()));
            statement.setString(5, String.valueOf(todoRecord.getEndDate()));
